...
2. Note to self, use MAMP for local testing. svg-edit will not load properly on a local
	machine due to cross-site scripting security issues. Use MAMP! See also
	https://github.com/mrdoob/three.js/wiki/How-to-run-things-locally Run Safari turn
